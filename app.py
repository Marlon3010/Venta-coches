...
car_data = pd.read_csv('~/Venta-coches/vehicles_us.csv')  # leer los datos
...
build_histogram2 = st.checkbox('Construir un histograma dispersión')

if build_histogram2:
    # hist_button2:  # al hacer clic en el botón
    # escribir un mensaje
    st.write(
        'Creación de un histograma dispersion')
